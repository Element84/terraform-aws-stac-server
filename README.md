...
stac-server releases prior to v5.0.0 do not include a lambda dist ZIP asset. To deploy an older version, or a custom build, build the ZIP from a stac-server checkout with `npm run build-lambda-dist` and point `stac_server_zip_filepath` at it.
