...
| <a name="input_resource_name_suffix"></a> [resource\_name\_suffix](#input\_resource\_name\_suffix) | (Optional) Suffix used with `fd-<project_name>-` to name all resources. Defaults to `stac_api_stage`. Set this to name resources independently of the API stage — e.g. serve the API at stage `v2` while resources stay named for the `dev` environment. | `string` | `null` | no |
